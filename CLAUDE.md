...
>
> **의료 복합어 허용 원칙**: 널리 쓰이는 질환명·진단명·시술명은 환자도 자주 검색하고 의료 맥락에서 자연스러운 표현이므로 본문에서 사용을 허용한다. 단, 첫 등장 시에는 환자용어를 먼저 제시하는 원칙을 유지한다.
> - 허용 의료 용어: `치주염`, `치은염`, `근관치료`, `치조골`, `골이식`, `치주 수술`, `치은 퇴축`
> - 예: "잇몸 염증(치은염)이 진행되면 치주염으로 발전할 수 있어요" — 환자용어 선행 후 의료 용어 자연스럽게 사용
