...
- 문장 길이에 변화를 주어 리듬감 유지: 설명 문장(2~3절 복문) 사이에 짧은 단문("이는 정상적인 반응입니다.")을 배치
