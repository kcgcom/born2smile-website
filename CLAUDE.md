...
>
> **의료 복합어 허용 원칙**: 널리 쓰이는 질환명·진단명·시술명은 환자도 자주 검색하고 의료 맥락에서 자연스러운 표현이므로, 괄호 설명 없이 단독으로 사용해도 된다. 매번 풀어쓰면 글이 길어지고 가독성이 떨어지므로, 문맥상 의미가 통하면 별도 설명 없이 바로 쓴다.
> - 허용 의료 용어: `치주염`, `치은염`, `근관치료`, `치조골`, `골이식`, `치주 수술`, `치은 퇴축`, `치수염`, `치수 괴사`, `치근단 절제술`, `치근 흡수`, `매복치`, `구내염`
> - 예: "치주염이 진행되면 잇몸뼈가 흡수될 수 있어요" — 치주염을 별도 설명 없이 바로 사용
> - 예: "치수염이 심해지면 신경치료가 필요합니다" — 치수염을 별도 설명 없이 바로 사용
...
| 지각 과민 | 지각 과민(자극에 치아가 민감해지는 상태) | 지각 과민 | 상아질 과민증·dentin hypersensitivity 단독 |
| 뼈 흡수 | 뼈 흡수(잇몸뼈가 줄어드는 것) | 뼈 흡수 | bone resorption 단독 |
| 매복치 | 매복치(잇몸 속에 묻혀 나오지 못한 치아) | 매복치 | impacted tooth 단독 |
| 구내염 | 구내염(입안 점막에 생기는 염증) | 구내염 | |
...
| 전체 틀니 | 전체 틀니(모든 치아를 대체하는 틀니) | 전체 틀니 | 총의치 단독 |
...
| 세라믹 | 세라믹(포세린, 치과용 도자기) | 세라믹 | porcelain 단독 |
