...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        heading: "교정 중 양치법",
        content:
          "교정 장치 주변에는 음식물과 세균막이 쉽게 쌓여 충치(치아우식증)나 잇몸 질환(치주 질환)의 위험이 높아져요. 매 식사 후 양치하는 습관이 중요합니다. 교정 전용 칫솔(V자형)과 치간칫솔을 함께 사용하면 장치 주변을 효과적으로 닦을 수 있어요. 치실은 교정 전용 치실 통과기를 활용하세요. 불소 치약과 불소 구강 청결제를 사용하면 충치 예방에도 도움이 됩니다.",
      },
      {
