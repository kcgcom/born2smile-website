    ...
    content: [
      {
        ...
        content:
          "\"장치 붙이고 사흘째인데 아직도 아파요\"라고 걱정하시는 분들 있어요. 치아가 제자리를 찾아가면서 나타나는 정상적인 반응이에요. 교정 장치도 보통 1주일 이내에 적응됩니다. 철사를 교체할 때마다 비슷한 증상이 반복되지만, 점차 가벼워져요.",
      },
      {
        heading: "교정 중 어떤 음식을 피해야 할까요?",
        content:
      ...
      {
        heading: "장치가 파손되거나 철사가 찔리면 어떻게 하나요?",
        content:
