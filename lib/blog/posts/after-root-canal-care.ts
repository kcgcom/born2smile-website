...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          "\"신경치료 받고 나서 이틀째 욱신거리는데 괜찮은 건가요?\"라고 걱정하시는 분들 있어요. 치아 뿌리 끝 주변 조직의 일시적인 염증 반응으로, 정상적인 과정이에요. 2~3일간 치아가 욱신거리거나 누르면 아픈 증상이 있을 수 있지만, 처방된 진통제를 복용하면 대부분 관리됩니다. 다만 1주일 이상 통증이 지속되거나 점점 심해지는 경우, 붓기나 고름이 나오는 경우에는 치과에 연락하세요.",
      },
      {
        heading: "크라운은 반드시 씌워야 하나요?",
        content:
