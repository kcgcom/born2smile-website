...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          "교정 직후 6개월에서 1년은 치아가 다시 움직이기 가장 쉬운 시기예요. 이 기간에는 식사할 때를 제외하고 하루 종일 가철식 유지장치를 착용해 주세요. 이후 치아 배열이 안정되면 취침 시에만 착용하는 것으로 줄여나갈 수 있습니다. 이상적으로는 가능한 한 오랫동안, 특히 잠잘 때만이라도 꾸준히 착용하시는 것이 가장 확실해요.",
      },
      {
