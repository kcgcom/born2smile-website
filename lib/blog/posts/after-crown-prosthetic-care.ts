...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          "크라운과 자연 치아의 경계에 세균막이 쌓이면 이차 충치나 잇몸 질환(치주 질환)이 생길 수 있어요. 양치할 때 잇몸 경계 부위를 꼼꼼히 닦아 주세요. 브릿지는 인공 치아 아래에 음식물이 끼기 쉬우니, 전용 치실이나 치간칫솔로 매일 관리하는 게 좋습니다. 얼음 깨물기 같은 과도한 힘은 파절의 원인이 되고, 이갈이가 있다면 취침 시 보호장치 착용을 권해 드려요.",
      },
      {
