...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          "\"크라운 씌우고 나서 높게 물리는 것 같아요\"라고 오시는 분들이 있어요. 치아 모양과 높이가 미세하게 달라 혀가 어색함을 느끼는 건데, 대부분 1~2주면 적응돼요. 장착 후 약 2시간은 식사를 피하고, 하루 정도는 부드러운 음식을 드세요. 높게 물린다는 느낌이 이틀 이상 지속되면 참지 마시고 치과에서 조정받으세요.",
      },
      {
        heading: "크라운, 어떻게 관리해야 오래 쓸 수 있을까요?",
        content:
