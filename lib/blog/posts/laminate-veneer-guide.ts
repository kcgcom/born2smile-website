...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          "라미네이트는 매우 얇기 때문에 강한 충격이나 힘에 깨지거나 떨어질 수 있어요. 딱딱한 음식(얼음, 사탕, 견과류)을 앞니로 깨무는 습관은 반드시 피해야 합니다. 이갈이·이 악물기가 심한 분은 라미네이트 파손 위험이 높아 나이트가드(자는 동안 끼는 보호장치) 착용이 필요해요. 또한 치아 삭제 후에는 시린 증상이 보통 2~3일 나타날 수 있고, 라미네이트가 탈락하면 삭제된 치아가 노출되므로 재시술이 필요합니다. 비용도 개당 50만~100만 원대로 적지 않아요.",
      },
      {
