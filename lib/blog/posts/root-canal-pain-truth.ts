...
export const post: BlogPost = {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          "신경치료는 보통 2~3회 내원이 필요합니다. 첫 방문에서 감염된 신경 조직을 제거하고 소독한 뒤 임시 재료로 막아둡니다. 이후 내원에서 소독을 반복하고, 염증이 가라앉으면 뿌리 내부를 특수 재료로 완전히 밀봉합니다. 각 치료 시간은 30분~1시간 정도이며, 매 회차마다 마취를 하므로 통증 걱정은 하지 않으셔도 됩니다. 치료를 미루면 감염이 진행되어 치료 기간이 길어지거나 발치가 필요할 수 있으니, 증상이 있다면 빨리 치과를 방문하시는 것이 좋습니다.",
      },
    ],
    date: "2026-02-14",
    readTime: "5분",
