    ...
    content: [
      {
        ...
        content:
          "치과 엑스레이는 눈으로 볼 수 없는 치아 내부와 뼈 상태를 확인하는 진단 도구예요. 건물 안전 점검에서 벽 속 배관을 확인하듯, 엑스레이는 치아 속 숨은 충치(치아우식증)나 잇몸뼈(치조골) 흡수, 사랑니(제3대구치) 위치 등을 정확히 파악하는 역할을 합니다. 육안만으로는 초기 병변을 놓치기 쉬워, 정확한 진단과 안전한 치료를 위해 꼭 필요한 과정이에요.",
      },
      {
