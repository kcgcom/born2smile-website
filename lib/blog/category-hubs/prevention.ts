...
export const preventionHub = defineCategoryHub({
  ...
  questions: [
    question("스케일링은 얼마나 자주 받아야 할까요?", "scaling-frequency-guide", "치석이 잘 생기는 정도와 잇몸 상태에 따라 주기가 달라지며, 정기검진에서 개인별 간격을 정하는 것이 좋습니다."),
    question("양치할 때 피가 나면 무엇을 먼저 확인해야 할까요?", "gum-disease-prevention", "출혈이 있다고 양치를 멈추기보다 잇몸 염증 여부를 점검하고 더 부드럽고 꼼꼼하게 관리해야 하는 경우가 많습니다."),
    question("치실과 치간칫솔은 어떻게 다르게 써야 하나요?", "interdental-brush-waterpik-guide", "치아 사이 공간 크기와 보철물 유무에 따라 적합한 도구가 달라지므로 상황에 맞게 병행하는 것이 효과적입니다."),
  ],
