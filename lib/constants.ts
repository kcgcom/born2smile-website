...
// -------------------------------------------------------------
export const STAFF = {
  credential: "보건복지부 치과위생사 면허",
  summary:
    "서울본치과의 전 직원은 보건복지부 치과위생사 면허증을 가진 구강관리 전문가로 이루어져 있습니다.",
  highlights: [
    {
      title: "국가 면허 보유",
      desc: "전 직원이 보건복지부가 인정하는 치과위생사 면허를 보유하고 있습니다.",
    },
    {
      title: "전문 스케일링",
      desc: "에어플로우 등 최신 장비를 활용한 전문적이고 통증 없는 스케일링을 제공합니다.",
    },
    {
      title: "맞춤 구강교육",
      desc: "환자 개개인의 구강 상태에 맞는 올바른 관리법을 안내합니다.",
    },
    {
      title: "예방처치 전문",
      desc: "불소 도포, 실란트 등 과학적 근거에 기반한 예방 진료를 시행합니다.",
    },
  ],
} as const;
...
// -------------------------------------------------------------
// 네비게이션 항목
// Header, FloatingCTA 등에서 공유
// -------------------------------------------------------------
export const NAV_ITEMS = [
  { href: "/", label: "홈", shortLabel: "홈" },
  { href: "/about", label: "병원 소개", shortLabel: "병원소개" },
  { href: "/treatments", label: "진료 안내", shortLabel: "진료안내" },
  { href: "/blog", label: "건강칼럼", shortLabel: "건강칼럼" },
  { href: "/contact", label: "상담 안내", shortLabel: "상담안내" },
] as const;
...
// -------------------------------------------------------------
export const SEO = {
  defaultTitle: "김포 장기동 치과 | 서울대 출신 전문의 | 서울본치과",
  titleTemplate: "%s | 서울본치과",
  defaultDescription:
    "서울본치과는 김포 한강신도시 장기동에서 서울대 출신 통합치의학전문의가 임플란트·치아교정·보존치료·예방진료를 정밀 진단 기반으로 진행하며, 과잉진료 없이 자연치아 보존을 우선으로 충분한 설명과 맞춤 치료 계획을 제공하는 주치의 치과입니다. 치료 전후 상담과 사후관리까지 동행합니다.",
  ogDescription:
    "서울대출신 치과전문의. 꼭 필요한 치료만, 오래오래 편안하게. 자연치아 살리기를 최우선으로 합니다.",
  keywords: [
    "김포치과",
    "김포시치과",
    "장기동치과",
