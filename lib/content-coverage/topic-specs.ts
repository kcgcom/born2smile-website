...
function concept(
  ...
  importance: CoverageConcept["importance"] = "required",
): CoverageConcept {
  return { id, label, description, weight, importance, criteria };
}
...
export const COVERAGE_TOPIC_SPECS: CoverageTopicSpec[] = [
  ...
  },
  {
    ...
    concepts: [
      concept("diagnosis", "문제와 진단", "손상 원인과 치아 보존 가능성 평가", 20, [criterion("problem-types", "문제 유형", "깨짐, 변색, 결손 등 문제 유형을 구분한다.", 50), criterion("exam", "진단", "치아와 잇몸 상태를 검사해 치료를 정함을 설명한다.", 50)]),
      concept("options", "치료 선택지", "레진·라미네이트·크라운·브릿지·임플란트의 역할", 30, [criterion("restorative", "보존 선택지", "레진, 라미네이트, 크라운의 차이를 설명한다.", 50), criterion("replacement", "결손 선택지", "브릿지와 임플란트 적용 상황을 설명한다.", 50)]),
      concept("suitability", "적합 조건", "손상 범위와 잇몸·교합에 따른 선택 기준", 20, [criterion("selection", "선택 기준", "치질, 잇몸, 교합에 따른 선택 기준을 설명한다.", 60), criterion("limits", "제한과 보존", "삭제량과 자연치아 보존을 설명한다.", 40)]),
      concept("aesthetics", "심미성과 기능", "색·형태·잇몸선과 기능 회복", 15, [criterion("appearance", "색과 형태", "인접 치아와 색과 형태를 맞추는 과정을 설명한다.", 60), criterion("function", "기능", "발음과 교합 등 기능을 설명한다.", 40, "recommended")]),
      concept("recovery-cost", "기간과 비용", "치료 기간, 회복과 비용 결정 요인", 15, [criterion("timeline", "치료 기간", "치료별 기간과 내원 횟수를 설명한다.", 50), criterion("cost", "비용 요인", "재료와 치료 범위에 따른 비용 차이를 설명한다.", 50)]),
    ],
  ...
  },
  {
    ...
    concepts: [
      concept("first-aid", "즉시 대처", "출혈·부종 관리와 치아 조각 보관 등 초기 행동", 25, [criterion("safe-actions", "안전한 초기 행동", "출혈과 부종에 대한 안전한 대처를 설명한다.", 60), criterion("preservation", "치아·조각 보관", "치아나 조각의 보관과 취급을 설명한다.", 40)]),
      concept("injury-types", "외상 유형", "깨짐, 흔들림, 탈구와 완전 탈락의 구분", 20, [criterion("classification", "외상 구분", "주요 외상 유형을 구분한다.", 60), criterion("primary-permanent", "유치·영구치 차이", "유치와 영구치의 대처 차이를 설명한다.", 40)]),
      concept("urgency", "응급 내원 기준", "즉시 내원이 필요한 상황과 시간 중요성", 25, [criterion("red-flags", "응급 신호", "심한 출혈, 탈락 등 응급 신호를 설명한다.", 60), criterion("timing", "내원 시점", "가능한 빠른 평가가 필요한 이유를 설명한다.", 40)]),
      concept("treatment-followup", "치료와 경과 관찰", "검사·치료와 변색·통증 등 후속 관찰", 20, [criterion("evaluation", "치과 검사", "방사선 검사와 치아 상태 평가를 설명한다.", 50), criterion("followup", "경과 관찰", "변색, 통증, 잇몸 변화의 관찰을 설명한다.", 50)]),
      concept("prevention", "재발 예방", "운동 보호장치와 생활 안전", 10, [criterion("prevention", "예방 방법", "마우스가드와 생활 안전을 설명한다.", 100, "recommended")], "recommended"),
    ],
  ...
  },
  {
    ...
    concepts: [
      concept("brushing", "칫솔질", "칫솔 선택과 올바른 칫솔질 방법", 25, [criterion("technique", "칫솔질 방법", "치아와 잇몸 경계를 닦는 방법을 설명한다.", 60), criterion("frequency", "빈도와 시간", "칫솔질 빈도와 시간을 설명한다.", 40)]),
      concept("interdental", "치아 사이 관리", "치실과 치간칫솔의 역할과 사용법", 25, [criterion("floss", "치실", "치실의 사용 대상과 방법을 설명한다.", 50), criterion("interdental-brush", "치간칫솔", "치간칫솔의 선택과 사용법을 설명한다.", 50)]),
      concept("devices", "보조 관리도구", "전동칫솔·워터픽·구강세정제의 역할과 한계", 20, [criterion("selection", "도구 선택", "상태에 맞는 보조 도구 선택을 설명한다.", 50), criterion("limitations", "도구의 한계", "보조 도구가 기본 관리를 완전히 대체하지 않음을 설명한다.", 50)]),
      concept("individual-care", "상황별 관리", "교정·임플란트·잇몸 상태에 따른 관리 차이", 15, [criterion("conditions", "상태별 방법", "구강 상태와 치료에 따른 관리 차이를 설명한다.", 100, "recommended")], "recommended"),
      concept("professional-care", "전문 관리", "정기검진과 스케일링의 필요성", 15, [criterion("checkup", "정기검진", "정기검진의 역할을 설명한다.", 50), criterion("scaling", "스케일링", "전문적인 치태·치석 관리 필요성을 설명한다.", 50)]),
    ],
