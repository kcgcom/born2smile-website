...
export const COVERAGE_TOPIC_SPECS: CoverageTopicSpec[] = [
  ...
  },
  {
    ...
    concepts: [
      ...
      concept("treatment-followup", "치료와 경과 관찰", "검사·치료와 변색·통증 등 후속 관찰", 20, [criterion("evaluation", "치과 검사", "방사선 검사와 치아 상태 평가를 설명한다.", 50), criterion("followup", "경과 관찰", "변색, 통증, 잇몸 변화의 관찰을 설명한다.", 50)], { identityPhrases: ["치아 외상", "치아 탈락", "치아 탈구", "이를 부딪", "치아를 부딪", "외상 후"], contextPhrases: ["변색", "치아 색", "경과", "관찰", "방사선", "검사", "검진"] }),
