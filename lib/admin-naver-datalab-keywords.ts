...
const NON_LOCAL_REGION_PATTERN =
  /강남|서초|송파|강동|마포|용산|종로|강서|양천|영등포|구로|관악|동작|서대문|은평|성북|동대문|중랑|노원|도봉|강북|광진|성동|수원|성남|분당|용인|화성|평택|안양|안산|시흥|광명|군포|의왕|과천|하남|이천|여주|양평|가평|포천|동두천|연천|양주|의정부|구리|남양주|고양|일산|파주|부천|오산|안성|인천|청라|대구|부산|울산|세종|제주|천안|전주|춘천|원주|강릉|속초|여수|순천|포항|경주|창원|진주|목포|군산|익산|당진|서산|아산|홍성/;

/** 김포 지역 허용 패턴 (이 패턴에 매칭되면 지역 필터 통과) */
const LOCAL_AREA_PATTERN =
  /김포|고촌|한강신도시|한강센트럴자이|장기동|풍무동|구래동|마산동|양촌|걸포동|운양동|사우동/;
